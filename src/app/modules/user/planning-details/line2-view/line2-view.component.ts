...
@Component({
    selector     : 'line2-view',
    templateUrl  : './line2-view.component.html',
    styleUrls    : ['./line2-view.component.scss'],
    animations: fuseAnimations,
    encapsulation: ViewEncapsulation.None
})
export class PlanningViewLine2Component implements OnInit, OnDestroy {
     ...
     */
    constructor( 
        public dialogRef: MatDialogRef<PlanningViewLine2Component>,
