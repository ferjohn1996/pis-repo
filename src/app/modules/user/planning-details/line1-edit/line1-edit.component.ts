...
@Component({
    selector     : 'line1-edit',
    templateUrl  : './line1-edit.component.html',
    styleUrls    : ['./line1-edit.component.scss'],
    animations: fuseAnimations,
    encapsulation: ViewEncapsulation.None
})
export class PlanningEditLine1Component implements OnInit, OnDestroy {
     ...
     */
    constructor( 
        public dialogRef: MatDialogRef<PlanningEditLine1Component>,
    ...
    onSubmit(): void {
        ...
        this._planningService
            .editPlanningLine1(this.lineId, mapData)
            .subscribe(
                (response: any) => {
                    Swal.fire({
                        title: "Success",
