...
@Component({
    selector     : 'line3-edit',
    templateUrl  : './line3-edit.component.html',
    styleUrls    : ['./line3-edit.component.scss'],
    animations: fuseAnimations,
    encapsulation: ViewEncapsulation.None
})
export class PlanningEditLine3Component implements OnInit, OnDestroy {
     ...
     */
    constructor( 
        public dialogRef: MatDialogRef<PlanningEditLine3Component>,
    ...
    ngOnInit(): void
    {
        this._planningService.getPlanningLine3ById(this.lineId)
            .then(data => {
    ...
    onSubmit(): void {
        ...
        this._planningService
            .editPlanningLine3(this.lineId, mapData)
            .subscribe(
                (response: any) => {
                    Swal.fire({
                        title: "Success",
