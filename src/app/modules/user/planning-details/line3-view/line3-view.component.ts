...
@Component({
    selector     : 'line3-view',
    templateUrl  : './line3-view.component.html',
    styleUrls    : ['./line3-view.component.scss'],
    animations: fuseAnimations,
    encapsulation: ViewEncapsulation.None
})
export class PlanningViewLine3Component implements OnInit, OnDestroy {
     ...
     */
    constructor( 
        public dialogRef: MatDialogRef<PlanningViewLine3Component>,
