...
@Component({
    selector     : 'line2-add',
    templateUrl  : './line2-add.component.html',
    styleUrls    : ['./line2-add.component.scss'],
    animations: fuseAnimations,
    encapsulation: ViewEncapsulation.None
})
export class PlanningAddLine2Component implements OnInit, OnDestroy {
     ...
     */
    constructor( 
        public dialogRef: MatDialogRef<PlanningAddLine2Component>,
